...
public final class home1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"search\" placeholder=\"Search for a city.....\">\n");
      out.write("\t\t\t\t\t\t<input type=\"submit\" value=\"Search\" class=\"btn btn-info\" style=\"margin-left: -5px\"><br><br><br>\n");
      out.write("                                                </form>\n");
      out.write("                                                <div id=\"bu\">\n");
      out.write("                                                    <button class=\"btn btn-success\"><a href=\"restaurant.jsp?search=");
request.getParameter("search");
      out.write("\"><i class=\"fa fa-spoon\" aria-hidden=\"true\"></i>Search Restaurants in ");
out.println(request.getParameter("search"));
      out.write("</a></button><br>\n");
      out.write("                                                <button class=\"btn btn-success\"><a href=\"hospital.jsp?search=");
request.getParameter("search");
      out.write("\"><i class=\"fa fa-h-square\" aria-hidden=\"true\"></i>Search Hospitals in ");
out.println(request.getParameter("search"));
      out.write("</a></button><br>\n");
      out.write("                                                <button class=\"btn btn-success\"><a href=\"school.jsp?search=");
request.getParameter("search");
      out.write("\"><i class=\"fa fa-graduation-cap\" aria-hidden=\"true\"></i>Search Schools in ");
out.println(request.getParameter("search"));
      out.write("</a></button><br>\n");
      out.write("                                                </div>\n");
      out.write("                                        </div>\n");
