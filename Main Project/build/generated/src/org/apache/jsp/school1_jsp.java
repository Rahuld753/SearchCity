...
public final class school1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<h1>Search Schools in Your City</h1\n");
      out.write("                                                <div id=\"id1\">\n");
      out.write("                                                <form action=\"school1.jsp\">\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" class=\"awesomplete\" name=\"search\" id=\"myinput\" data-minchars=\"0\" placeholder=\"Search for a city.....\">\n");
      out.write("                                                <input type=\"submit\" value=\"Search\" class=\"btn btn-info\" style=\"margin-left: -5px\" id=\"bt\"><br><br><br>\n");
      out.write("                                                </form>\n");
      out.write("                                                </div>\n");
      out.write("                                                ");
                                                    ...
                                                    do
                                                    {
                                                          out.println("<div align=\"left\" id=\"car\"><a href="+rs.getString(6)+" target=\"_blank\">"
                                                                  + "<h1>"+rs.getString(2)+
                                                                  "</h1></a><p><img src=schoolimg//"+rs.getString(5)+" align=\"left\"></p><p id=\"head\" style=\"font-size:25px\">Address:<br></p><p>"+rs.getString(3)+"<br></p><p id=\"head\" style=\"font-size:25px\">Phone:<br></p><p>"+rs.getString(4)+"</p></div>");
                                                    }while(rs.next());
                                                    }
                                                    else
