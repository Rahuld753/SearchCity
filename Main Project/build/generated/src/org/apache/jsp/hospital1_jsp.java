...
public final class hospital1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<h1>Search Hospitals in Your City</h1>\n");
      out.write("                                                <div id=\"id1\">\n");
      out.write("                                                <form action=\"hospital1.jsp\">\n");
      ...
      out.write("                                                ");
                                                    ...
                                                    PreparedStatement st=con.prepareStatement("call srchhospital(?)");
                                                    ...
                                                    do
                                                    {
                                                          out.println("<div align=\"left\" id=\"car\"><a href="+rs.getString(6)+" target=\"_blank\">"
                                                                  + "<h1>"+rs.getString(2)+
                                                                  "</h1></a><p><img src=hospimg//"+rs.getString(5)+" align=\"left\"></p><p id=\"head\" style=\"font-size:25px\">Address:<br></p><p>"+rs.getString(3)+"<br></p><p id=\"head\" style=\"font-size:25px\">Phone:<br></p><p>"+rs.getString(4)+"</p></div>");
                                                    }while(rs.next());
                                                    }
                                                    else
