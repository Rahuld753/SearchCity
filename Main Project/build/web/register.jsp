<%-- 
    Document   : register
    Created on : Oct 3, 2017, 12:18:36 AM
    Author     : Rahul
--%>
				...
				<div class="row">
					<div class="col-lg-12" align="center">
						<h1 style="margin-bottom: 50px;">REGISTER</h1>
                                                ...
                                                <input type="text" name="us1" placeholder="Enter Your Username...."><br>
                                                <input type="password" name="pass1" placeholder="Enter Your Password...."><br>
                                                <input type="submit" style="background:blueviolet" value="Register" style="margin-bottom: 25px"><br>
                                                </form>
                                                </div> 
					</div>
				</div>
