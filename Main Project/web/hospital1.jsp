<%-- 
    Document   : hospital1
    Created on : Sep 30, 2017, 9:21:33 AM
    Author     : Rahul
--%>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12" align="center">
						<h1>Search Hospitals in Your City</h1>
                                                <div id="id1">
                                                <form action="hospital1.jsp">
                                                ...
                                                <%
                                                    ...
                                                    do
                                                    {
                                                          out.println("<div align=\"left\" id=\"car\"><a href="+rs.getString(6)+" target=\"_blank\">"
                                                                  + "<h1>"+rs.getString(2)+
                                                                  "</h1></a><p><img src=hospital//"+rs.getString(5)+" align=\"left\"></p><p id=\"head\" style=\"font-size:25px\">Address:<br></p><p>"+rs.getString(3)+"<br></p><p id=\"head\" style=\"font-size:25px\">Phone:<br></p><p>"+rs.getString(4)+"</p></div>");
                                                    }while(rs.next());
                                                    }
                                                    else
